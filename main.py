...
for i in uaids:
    res = requests.patch(url=f'https://economy.roblox.com/v1/assets/{item_id}/resellable-copies/{i}', json={"price":price}, headers={'cookie': roblosecurity, 'x-csrf-token': token})
